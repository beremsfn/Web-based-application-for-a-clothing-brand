      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex flex-wrap justify-between items-center">
          ...
          <nav className="flex flex-wrap items-center gap-4">
            <Link
              to={"/"}
              className="text-gray-300 hover:primary transition duration-300
					 ease-in-out"
            >
              Home
            </Link>
            {user && (
              <Link
                to={"/cart"}
                className="relative group text-gray-300 hover:primary transition duration-300 
							ease-in-out"
              >
                <ShoppingCart
                ...
                {cart.length > 0 && (
                  <span
                    className="absolute -top-2 -left-2 bg-primary text-white rounded-full px-2 py-0.5 
									text-xs group-hover:bg-primary transition duration-300 ease-in-out"
                  >
                    {cart.length}
                  </span>
                )}
